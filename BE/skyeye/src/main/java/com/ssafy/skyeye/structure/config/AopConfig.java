...
public class AopConfig {
    ...
    @AfterThrowing(value = "execution(* com.ssafy.skyeye.controller.*.*(..))", throwing = "e")
...
//        logger.error("Method Parameter : {}", arg.toString());
    ...
    @AfterReturning(value = "execution(* com.ssafy.skyeye.controller.*.*(..))", returning = "returnValue")
    ...
    @AfterReturning(value = "execution(* com.ssafy.skyeye.interceptor.*.*(..))", returning = "returnValue")
